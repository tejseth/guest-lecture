...
- When I was young I was more interested in the back of baseball cards than the front
- Didn't necessarily like math class but was better at it than other classes
- In high school, I spent time messing around with data on Google Sheets
  - It was tedious before I knew how to code in R...
...
```{r echo = FALSE, fig.align = 'center', out.height = 200, out.width= 350}
...
- Working in the Research & Development team allowed me to grow in multiple facets
  ...
  - Had my [writing](https://www.pff.com/analyst/tej-seth)
...
```{r echo = FALSE, fig.align = 'center', out.height = 250, out.width= 350}
